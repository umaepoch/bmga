...
def get_permissible_expiry_limit(customer):
	...
	return dict(limit = r.get('pch_replacement', 0)/100 * (invoice_amount + invoice_return), remainder = r.get('pch_replacement', 0)/100 * (invoice_amount) + invoice_return, invoice_amount = invoice_amount, invoice_return = invoice_return, replacement = r.get('pch_replacement', 0))
